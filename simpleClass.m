...
rate = 0.001;       % Rate of selected pixels per class
Xtrain = [];
Ytrain = [];
...
METHODS = {'LDA' 'QDA' 'MAHALANOBIS' 'k-NN' 'TREE' 'BAG' 'ADABOOST' 'RF' 'NN' 'SVM'}
...
figure,
bar([OAS_LDA,OAS_QDA,OAS_MAHALANOBIS,OAS_KNN,OAS_TREE,OAS_BAG,OAS_BOOST,OAS_RF,OAS_NN,OAS_SVM])
set(gca,'Xtick',1:10,'XTickLabel',METHODS)
...
figure,
bar([KAPPA_LDA,KAPPA_QDA,KAPPA_MAHALANOBIS,KAPPA_KNN,KAPPA_TREE,KAPPA_BAG,KAPPA_BOOST,KAPPA_RF,KAPPA_NN,KAPPA_SVM])
set(gca,'Xtick',1:10,'XTickLabel',METHODS)
...
% CPU times
figure,
barh(log10([time_LDA,time_QDA,time_MAHAL,time_KNN,time_TREE,time_BAG,time_BOOST,time_RF,time_NN,time_SVM]))
xlabel('')
